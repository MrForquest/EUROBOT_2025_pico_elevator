...
// //	spi_init(spi_default, 500 * 1000);  //Проинициализировано ранее в функции Setup();
// //    gpio_set_function(PICO_DEFAULT_SPI_RX_PIN, GPIO_FUNC_SPI);
//     gpio_set_function(_TFT_SCLK, GPIO_FUNC_SPI);
//     gpio_set_function(_TFT_SDATA, GPIO_FUNC_SPI);
	
// 	gpio_init(_TFT_CS);
//     gpio_set_dir(_TFT_CS, GPIO_OUT);
//     gpio_put(_TFT_CS, 1);

// 	// gpio_init(_TFT_SDATA);
//     // gpio_set_dir(_TFT_SDATA, GPIO_OUT);
//     // gpio_put(_TFT_SDATA, 1);
}
